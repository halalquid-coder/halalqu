...
const translations = {
    id: {
        ...
        settings: '⚙️ Pengaturan', aboutHalalqu: 'Tentang Halalqu',
        logout: '🚪 Keluar', deleteAccount: '🗑️ Hapus Akun Saya',
    ...
    en: {
        ...
        travelGuide: '🧳 Travel Guide',
        home: 'Home', search: 'Search', scan: 'Scan', travel: 'Travel', profile: 'Profile',
        settings: '⚙️ Settings', aboutHalalqu: 'About Halalqu',
        logout: '🚪 Logout', deleteAccount: '🗑️ Delete My Account',
